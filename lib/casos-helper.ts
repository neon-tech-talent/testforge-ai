...
export async function generarYGuardarCasosDePrueba(proyectoId: string): Promise<any[]> {
...
`;
    ...
    try {
      ...
      console.error("Error al conectar con Gemini API:", apiErr);
    }
  }
  ...
  // Primero eliminamos los casos anteriores
  await supabase
    .from("casos_prueba")
    .delete()
    .eq("proyecto_id", proyectoId);
